...
class ShippingInformationManagementPlugin
{
    ...
    public function beforeSaveAddressInformation(
        ...
        $quote->setFisica($extensionAttributes->getFisica());
        $quote->setJuridica($extensionAttributes->getJuridica());
        $quote->setOtro($extensionAttributes->getOtro());
        $quote->setFactura($extensionAttributes->getFactura());
