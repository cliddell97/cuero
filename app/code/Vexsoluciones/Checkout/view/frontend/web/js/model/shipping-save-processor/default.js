...
define(
	...
	$,
        ...
        return {
 		...
 		var Factura = $('[name="custom_attributes[factura]"]').val();
		var Fisica = $('[name="custom_attributes[fisica]"]').val();
		var Juridica = $('[name="custom_attributes[juridica]"]').val();
		var Otro = $('[name="custom_attributes[otro]"]').val();
