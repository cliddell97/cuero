...
return [
    'modules' => [
        ...
        'Imagineer_AlinearColones' => 1,
        'Imagineer_CustomAddressCanton' => 0,
        'Imagineer_CustomAddressDistrito' => 0,
        'Imagineer_CustomAddressProvincia' => 0,
        'Imagineer_CustomMenu' => 1,
        'Imagineer_Layouts19' => 1,
        'Imagineer_MensajeriaDirecta' => 1,
        'Imagineer_Moovin' => 1,
        'Imagineer_RecogerPinares' => 1,
        'Imagineer_RecogerSabana' => 1,
        'Imagineer_RevisionPagos' => 1,
        'Imagineer_SegunGAM' => 1,
        'Imagineer_ShippingCorreosDeCostaRica' => 1,
        'Klarna_Core' => 1,
        ...
        'Remmote_Credomaticpayment' => 1,
        'Temando_ShippingRemover' => 1,
        'Ulmod_OrderComment' => 1,
        'Vertex_Tax' => 1,
        'Vertex_AddressValidation' => 1,
        'Vexsoluciones_Checkout' => 0,
        'YogeshKhasturi_GeoIpRedirection' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
